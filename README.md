...
The Sprig-C6 board features the MAX17048 battery capacity measurement IC connected to the respective I2C pins. In the `c6-config.yaml` provided, there is a sample code for proper communication with the ic. No further setup required.
